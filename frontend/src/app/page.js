...
export default function Home() {
  ...
  return (
    <div className="bg-gradient-to-b from-white via-slate-50/30 to-white relative">
      ...
      {/* 6. Categories Section - Premium Grid */}
      <section className="relative z-10 py-20 md:py-28 bg-gradient-to-br from-emerald-50/80 via-white to-green-50/60 overflow-hidden">
        ...
        {/* Dot grid overlay */}
        <div className="absolute inset-0 opacity-[0.025] pointer-events-none" style={{ backgroundImage: 'radial-gradient(circle, #059669 1px, transparent 1px)', backgroundSize: '32px 32px' }} />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center mb-12 md:mb-20 space-y-5">
            ...
            <p className="text-base md:text-xl text-gray-500 font-medium max-w-2xl mx-auto">
              From fresh produce to everyday household essentials — all in one place.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4 lg:gap-5 mb-14">
            {isDataLoading
              ? [...Array(12)].map((_, i) => (
                <div key={i} className="animate-pulse aspect-[4/5] rounded-2xl bg-gradient-to-br from-emerald-100 to-green-100" />
              ))
